...
public class EntRecordCheckResultVo
{
	...
	public EntRecordCheckResultVo(EnterpriseVo enterpriseVo, Date checkTime, Date startTime, Date endTime,
	...
	protected EntRecordCheckResultVo(EnterpriseVo enterpriseVo, String erorrMsg)
	{
		this.enterpriseId = enterpriseVo.getEnterpriseId();
		this.enterpriseName = enterpriseVo.getEnterpriseName();
	...
	public static EntRecordCheckResultVo fail(EnterpriseVo enterpriseVo, Exception e)
	{
		return new EntRecordCheckResultVo(enterpriseVo, e.getMessage());
	}
